...
struct DevicesClassicView: View {
                        ...
                        if store.servers.isEmpty {
                            ...
                            LazyVGrid(columns: layout.columns, spacing: layout.spacing) {
                                ForEach(store.servers) { config in
                                    ...
                                    .onDrop(
                                        of: [UTType.text],
                                        delegate: ClassicDeviceCardDropDelegate(
                                            current: config,
                            ...
                            .onDrop(
                                of: [UTType.text],
                                delegate: ClassicDeviceListDropDelegate(draggedServer: $draggedServer)
                            )
    ...
    private func layoutMetrics(for width: CGFloat) -> ClassicDeviceGridLayout {
        ...
        return ClassicDeviceGridLayout(
...
private struct ClassicDeviceGridLayout {
...
private struct ClassicDeviceCardDropDelegate: DropDelegate {
...
private struct ClassicDeviceListDropDelegate: DropDelegate {
    @Binding var draggedServer: ServerConfig?
