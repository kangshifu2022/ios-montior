...
enum TerminalTmuxService {
    ...
    private static func parse(_ output: String) -> TerminalRemoteTmuxSnapshot {
    ...
    private static func parseSession(_ line: String) -> TerminalRemoteTmuxSession? {
    ...
    private static let listSessionsScript = """
